...
@XmlRootElement
@XmlType(name = "retrieveAllMoviesRsp", propOrder = {
    "movieEntities"
})
public class RetrieveAllMoviesRsp {
    
    private List<MovieEntity> movieEntities;

    public RetrieveAllMoviesRsp() {
    }

    public RetrieveAllMoviesRsp(List<MovieEntity> movieEntities) {
