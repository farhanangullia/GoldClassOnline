 ...
 */
@XmlRootElement
@XmlType(name = "retrieveAllScreeningSchedulesByCinemaAndMovieRsp", propOrder = {
    "screeningSchedules"
})
public class RetrieveAllScreeningSchedulesByCinemaAndMovieRsp {
    
    private List<ScreeningSchedule> screeningSchedules;

    public RetrieveAllScreeningSchedulesByCinemaAndMovieRsp() {
    }

    public RetrieveAllScreeningSchedulesByCinemaAndMovieRsp(List<ScreeningSchedule> screeningSchedules) {
